# xtra_p1.py
"""
Desiree Thompson 1/15/2023
Creation of a gamebot for futher learning on module 1 lessons. 
...
user_choice = input("Please select a wolf, eagle, or snake as your animal: ")
